...
$result = get_all_post_categories_by_user_id($_SESSION['user_id']);
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_post_category.php?post_category_id=<?php echo urlencode($row['id']); ?>"><button type="button" class="btn btn-info">Edit</button></a>
                    </td>
                </tr>
            <?php } ?>
        </table>
